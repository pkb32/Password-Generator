...
function Card(props /*or tu eemiti kare {username} eemiti bhi kari haba*/) {
    console.log(props.username /*or tu eemiti kare {username} eemiti bhi kari haba*/)
  return (
    <div>
      <div className="w-60 h-60 rounded-xl">
        ...
        <div className="glass py-4 px-5 relative -top-[3.4rem]  rounded-b-xl z-10">
          <h1 className="font-bold  font-mono  text-xl text-green-500">{props.username}</h1>
        </div>
      </div>
    </div>
  )
